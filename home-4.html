  ...
  >
        ...
        >
          ...
          <nav class="navbar w-full">
            <ul class="flex flex-col lg:flex-row">
              <li class="js-nav-dropdown group relative">
                ...
                <ul
                  class="dropdown-menu left-0 top-[85%] z-10 hidden min-w-[200px] gap-x-4 whitespace-nowrap rounded-xl bg-white transition-all will-change-transform group-hover:visible group-hover:opacity-100 dark:bg-jacarta-800 lg:invisible lg:absolute lg:grid lg:translate-y-4 lg:py-4 lg:px-2 lg:opacity-0 lg:shadow-2xl lg:group-hover:translate-y-2"
                ...
                >
                  <li>
                    ...
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 1</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 2</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 3</span>
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 5</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Home 6</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 7</span>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 8</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                ...
                >
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Case Studies</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Single Case Study</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center justify-between rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Careers</span>
                      <span class="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white"
                        >new</span
                      >
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Item Details</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Explore Collections</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Collection</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Activity</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Rankings</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">User</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Edit Profile</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">About</span>
                    </a>
                  </li>
                  ...
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Contact</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Wallet</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Login</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Page 404</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Terms of Service</span>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="js-nav-dropdown nav-item dropdown group relative">
                ...
                <ul
                  class="dropdown-menu -left-6 top-[85%] z-10 hidden grid-flow-col grid-rows-5 gap-x-4 whitespace-nowrap rounded-xl bg-white transition-all will-change-transform group-hover:visible group-hover:opacity-100 dark:bg-jacarta-800 lg:invisible lg:absolute lg:!grid lg:translate-y-4 lg:py-8 lg:px-5 lg:opacity-0 lg:shadow-2xl lg:group-hover:translate-y-2"
                  aria-labelledby="navDropdown-1"
                >
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">All NFTs</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Art</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Collectibles</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Domain Names</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Music</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Photography</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Sports</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Trading Cards</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Utility</span>
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Virtual Worlds</span>
                    </a>
                  </li>
                </ul>
              </li>
                ...
                >
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Help Center</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Platform Status</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Partners</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Blog</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Single Post</span>
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      class="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span class="font-display text-sm text-jacarta-700 dark:text-white">Newsletter</span>
                    </a>
                  </li>
                </ul>
              </li>
          ...
          <div class="ml-8 hidden lg:flex xl:ml-12">
            ...
            <div class="js-nav-dropdown group-dropdown relative">
              ...
              <div
                class="dropdown-menu !-right-4 !top-[85%] !left-auto z-10 hidden min-w-[14rem] whitespace-nowrap rounded-xl bg-white transition-all will-change-transform before:absolute before:-top-3 before:h-3 before:w-full group-dropdown-hover:visible group-dropdown-hover:opacity-100 dark:bg-jacarta-800 lg:invisible lg:absolute lg:grid lg:!translate-y-4 lg:py-4 lg:px-2 lg:opacity-0 lg:shadow-2xl"
    ...
    <main>
        ...
        <div class="container">
          <div class="mx-auto max-w-2xl pt-24 text-center">
            <h1 class="mb-10 font-display text-5xl text-jacarta-700 dark:text-white lg:text-6xl xl:text-7xl">
              ...
              <span class="animate-gradient">Creative NFTs</span>
            </h1>
            <!-- Search -->
            ...
            <a href="#" class="text-accent hover:text-jacarta-700 dark:hover:text-white">cryptopunks</a><span>,</span>
            <a href="#" class="text-accent hover:text-jacarta-700 dark:hover:text-white">bored ape yacht club</a
            ><span>,</span>
      ...
      <div class="relative px-6 pb-16 sm:px-0">
            ...
            <div class="swiper-slide">
              <article>
                ...
                >
                  ...
                  <div class="p-6">
                    <div class="flex">
                      <a href="user.html" class="shrink-0">
                        <img src="img/avatars/avatar_18_rounded.gif" alt="avatar" class="mr-4 h-10 w-10 rounded-full" />
                      </a>
                      <div>
                        <a href="item.html" class="block">
                          <span
                            class="font-display text-lg leading-none text-jacarta-700 hover:text-accent dark:text-white"
                            >Etherium NFT Launching Lab</span
                          >
                        </a>
                        <a href="#" class="text-2xs text-accent">051_Hart</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <article>
                ...
                >
                  ...
                  <div class="p-6">
                    <div class="flex">
                      <a href="user.html" class="shrink-0">
                        <img src="img/avatars/avatar_22_rounded.jpg" alt="avatar" class="mr-4 h-10 w-10 rounded-full" />
                      </a>
                      <div>
                        <a href="item.html" class="block">
                          <span
                            class="font-display text-lg leading-none text-jacarta-700 hover:text-accent dark:text-white"
                            >Oceania \\ OVERSEER 017</span
                          >
                        </a>
                        <a href="#" class="text-2xs text-accent">MadeByM1KE</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <article>
                ...
                >
                  ...
                  <div class="p-6">
                    <div class="flex">
                      <a href="user.html" class="shrink-0">
                        <img src="img/avatars/avatar_17_rounded.jpg" alt="avatar" class="mr-4 h-10 w-10 rounded-full" />
                      </a>
                      <div>
                        <a href="item.html" class="block">
                          <span
                        ...
                        <a href="#" class="text-2xs text-accent">Wow Frens</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <article>
                ...
                >
                  ...
                  <div class="p-6">
                    <div class="flex">
                      <a href="user.html" class="shrink-0">
                        <img src="img/avatars/avatar_19_rounded.jpg" alt="avatar" class="mr-4 h-10 w-10 rounded-full" />
                      </a>
                      <div>
                        <a href="item.html" class="block">
                          <span
                        ...
                        <a href="#" class="text-2xs text-accent">Lila Spacex</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <article>
                ...
                >
                  ...
                  <div class="p-6">
                    <div class="flex">
                      <a href="user.html" class="shrink-0">
                        <img src="img/avatars/avatar_20_rounded.jpg" alt="avatar" class="mr-4 h-10 w-10 rounded-full" />
                      </a>
                      <div>
                        <a href="item.html" class="block">
                          <span
                        ...
                        <a href="#" class="text-2xs text-accent">Bored Bunny</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <!-- Navigation -->
        <div
          class="swiper-button-prev-4 group absolute top-1/2 left-4 z-10 -mt-6 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-white p-3 text-base shadow-white-volume"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <div
          class="swiper-button-next-4 group absolute top-1/2 right-4 z-10 -mt-6 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-white p-3 text-base shadow-white-volume"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <div class="container">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-[1.875rem] lg:grid-cols-4">
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_3.jpg" alt="avatar 3" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    3
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_4.jpg" alt="avatar 4" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    4
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_6.gif" alt="avatar 6" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    6
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_8.jpg" alt="avatar 8" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    8
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_11.jpg" alt="avatar 11" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    11
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_12.jpg" alt="avatar 12" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    12
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_14.jpg" alt="avatar 14" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    14
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_15.jpg" alt="avatar 15" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    15
            ...
            >
              <figure class="mr-4 shrink-0">
                <a href="collection.html" class="relative block">
                  <img src="img/avatars/avatar_16.jpg" alt="avatar 16" class="rounded-2lg" loading="lazy" />
                  <div
                    class="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600"
                  >
                    16
          ...
          <div class="grid grid-cols-1 gap-[1.875rem] md:grid-cols-2 lg:grid-cols-4">
            <article>
              ...
              >
                ...
                <figure class="relative">
                  ...
                  >
                    <span
                      class="h-3.5 w-3.5 shrink-0 bg-contain bg-center"
                      style="
                        background-image: url(https://cdn.jsdelivr.net/npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
                      "
                    ></span>
                    <span
                      class="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700"
            ...
            <article>
              ...
              >
                ...
                <div class="mt-2 text-sm">
                  <span class="dark:text-jacarta-300">Highest Bid</span>
                  <span class="text-jacarta-700 dark:text-jacarta-100">10 ETH</span>
                </div>
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <span class="text-sm dark:text-jacarta-200">60</span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article>
              ...
              >
                ...
                <div class="mt-2 text-sm">
                  <span class="dark:text-jacarta-300">Highest Bid</span>
                  <span class="text-jacarta-700 dark:text-jacarta-100">0.8 ETH</span>
                </div>
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <span class="text-sm dark:text-jacarta-200">34</span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article>
              ...
              >
                ...
                <div class="mt-2 text-sm">
                  <span class="dark:text-jacarta-300">Highest Bid</span>
                  <span class="text-jacarta-700 dark:text-jacarta-100">1.75 ETH</span>
                </div>
            ...
            <article>
              ...
              >
                ...
                <div class="mt-2 text-sm">
                  <span class="dark:text-jacarta-300">Highest Bid</span>
                  <span class="text-jacarta-700 dark:text-jacarta-100">9.3712 ETH</span>
                </div>
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <span class="text-sm dark:text-jacarta-200">334</span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article>
              ...
              >
                ...
                <div class="mt-2 text-sm">
                  <span class="dark:text-jacarta-300">Highest Bid</span>
                  <span class="text-jacarta-700 dark:text-jacarta-100">7.3 ETH</span>
                </div>
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <span class="text-sm dark:text-jacarta-200">52</span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article>
              ...
              >
                ...
                <div class="mt-2 text-sm">
                  <span class="dark:text-jacarta-300">Highest Bid</span>
                  <span class="text-jacarta-700 dark:text-jacarta-100">0.32 ETH</span>
                </div>
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <span class="text-sm dark:text-jacarta-200">90</span>
                  </div>
                </div>
              </div>
            </article>
              ...
              >
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  <div class="flex items-center space-x-1">
                    ...
                    <span class="text-sm dark:text-jacarta-200">260</span>
                  </div>
                </div>
              </div>
            </article>
      ...
      <section class="py-24">
        <div class="container">
          ...
          <div class="relative">
            ...
            <!-- Slider Navigation -->
            <div
              class="swiper-button-prev-2 group absolute top-1/2 -left-4 z-10 -mt-6 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-white p-3 text-base shadow-white-volume sm:-left-6"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <div
              class="swiper-button-next-2 group absolute top-1/2 -right-4 z-10 -mt-6 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-white p-3 text-base shadow-white-volume sm:-right-6"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
